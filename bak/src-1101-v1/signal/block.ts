 ...
 */
export function blockStatus<P extends object = object>(cb: BlockStatusCb<P>, options?: IBlockOptions<P>) {
 ...
 */
export function dynamicBlockStatus<P extends object = object>(cb: BlockStatusCb<P>, options?: IBlockOptions<P>) {
