...
import type { IBoundStateInfo, IActionTaskParams, DraftType, UnconfirmedArg, IMutateTaskParam, IMutateFnItem, IMutateFnParams } from 'helux';
...
export const ctx = sharex(getInitial, { moduleName: 'CompWithModule4' });

export type State = typeof ctx.state;
export type Draft = DraftType<State>;
export type BoundStateInfo = IBoundStateInfo<typeof ctx.stateRoot>;
